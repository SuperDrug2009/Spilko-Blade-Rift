...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m6B4FEC85C78AA00269F440121A5297DB65B6D164(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 48));
...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			Dictionary_2_set_Item_m725DDAF4C8BD4FBCD106BFFB1B4B5B74D7696281(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15))), il2cpp_rgctx_method(method->klass->rgctx_data, 52));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m565FF565A32678434AB3DD604FD18BF39447DA7D(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 48));
		return (RuntimeObject*)L_0;
	}
}
